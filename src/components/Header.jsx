...
function Header({ onTabChange }) {
  return (
    <header className="sticky top-0 w-full gaegu-regular flex justify-between Header h-32 z-10 text-xl">

      <div className='w-1/2 z-10 h-full'>
        <img src='/assets/paper-clip.png' alt="Paper Clip" className='
        // GENERAL absolute z-30 -left-7 customShadow
        // SMALLSCREENS hidden
        ...
        '/>
        <h1 className="
        // SMALLSCREENS/GENERAL relative z-20 w-full pl-7 text-lg pt-8 h-28  text-slate-950 gaegu-regular
        ...
        // SMALLSCREENS/GENERAL w-[22rem] h-40 absolute z-10 -left-28 -top-10 rotate-[-7deg] drop-shadow-md
