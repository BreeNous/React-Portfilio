        ...
        <footer className="gaegu-regular flex flex-wrap md:flex-nowrap lg:flex-nowrap justify-between items-center px-6 py-2 md:py-4 lg:py-4 mt-auto w-full text-slate-950 absolute h-24 lg:h-32 md:h-32 overflow-clip bottom-0 z-10">
            ...
            // LARGESCREENS lg:w-1/2 lg:justify-normal lg:ms-5">
                ...
                <li className="flex justify-center items-center">
                    <a href="https://github.com/BreeNous" className="text-slate-950 hover:text-amber-50 bg-brown-texture w-10 md:w-12 lg:w-12 h-10 md:h-12 lg:h-12 rounded-full flex items-center justify-center shadow-sm shadow-stone-500">
                ...
                <li className="flex justify-center items-center">
                    <a href="https://www.linkedin.com/in/breeanna-nouskhajian-259658318/" className="text-slate-950 hover:text-amber-50 ms-5 bg-brown-texture w-10 md:w-12 lg:w-12 h-10 md:h-12 lg:h-12 rounded-full flex items-center justify-center shadow-sm shadow-stone-500">
                ...
                <li className="flex justify-center items-center">
                    <a href="https://discord.com/" className="text-slate-950 hover:text-amber-50 ms-5 bg-brown-texture w-10 md:w-12 lg:w-12 h-10 md:h-12 lg:h-12 rounded-full flex items-center justify-center shadow-sm shadow-stone-500">
                ...
                <li className="flex justify-center items-center">
                    <a href="https://slack.com/" className="text-slate-950 hover:text-amber-50 ms-5 bg-brown-texture w-10 md:w-12 lg:w-12 h-10 md:h-12 lg:h-12 rounded-full flex items-center justify-center shadow-sm shadow-stone-500">
