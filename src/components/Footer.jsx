        ...
        <footer className="z-10 cutive-mono-regular Footer flex justify-between items-center px-10 mt-auto text-slate-950 fixed bottom-0">
            ...
            <ul className="flex pb-3">
                ...
                <li className="flex justify-center items-center">
                    <a href="https://github.com/BreeNous" className="text-slate-950 hover:text-amber-50 ms-5 bg-brown-texture w-12 h-12 rounded-full flex items-center justify-center">
                ...
                <li className="flex justify-center items-center">
                    <a href="https://www.linkedin.com/in/breeanna-nouskhajian-259658318/" className="text-slate-950 hover:text-amber-50 ms-5 bg-brown-texture w-12 h-12 rounded-full flex items-center justify-center">
                ...
                <li className="flex justify-center items-center">
                    <a href="https://discord.com/" className="text-slate-950 hover:text-amber-50 ms-5 bg-brown-texture w-12 h-12 rounded-full flex items-center justify-center">
                ...
                <li className="flex justify-center items-center">
                    <a href="https://slack.com/" className="text-slate-950 hover:text-amber-50 ms-5 bg-brown-texture w-12 h-12 rounded-full flex items-center justify-center">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="w-7" viewBox="0 0 512 512">
