...
function Footer() {
    ...
    return (
        ...
        // LG_SCREENS: lg:flex-nowrap lg:py-4 lg:h-32
        // XL_SCREENS: xl:flex-nowrap xl:py-4 xl:h-32">

            <ul className="
            // ALL_SCREENS: flex justify-center
            // SM_SCREENS: w-full ms-0
            // MD_SCREENS: md:w-1/2 md:justify-normal md:ms-5
            // LG_SCREENS: lg:w-1/2 lg:justify-normal lg:ms-5
            // XL_SCREENS: xl:w-1/2 xl:justify-normal xl:ms-5">
            ...
            <img src='assets/ripped-paper-white-2.png' 
                ...
                // SM_SCREENS: hidden
                // MD_SCREENS: md:-right-20 md:w-[27rem] md:block
                // LG_SCREENS: lg:-right-20 lg:-bottom-14 lg:w-[30rem] lg:block
                // XL_SCREENS:">
            </img>
