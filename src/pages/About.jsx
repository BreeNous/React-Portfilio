    ...
    return(
        <div className="flex h-full w-full">
            ...
            <div className="w-1/2 h-full relative">
                ...
                {/* ARCH PICTURE */}
                <img src="/assets/arch-asset.png" className="absolute w-[22rem] h-[33.5rem] left-[13rem] top-[3.5rem] drop-shadow-sm"></img>
                {/* BOTTOM TAPE */}
                <img src="/assets/long-tape.png" className="absolute w-[13rem] rotate-[10deg] left-[10.5rem] bottom-[0rem] z-10 drop-shadow-sm"></img>
                {/* BROWN BOX */}
                ...
                {/* BOOK STICKER */}
                <img src="/assets/book.png" className="w-[10rem] absolute right-[8rem] bottom-[4rem] drop-shadow-sm z-10"></img>
            ...
            {/* RIGHT SIDE */}
            <div className="w-1/2">
                <img src="/assets/green-pond.png" className="fixed right-0 -bottom-14 w-1/2"></img>
                <div className="bg-image w-[23rem] h-[33.2rem] absolute right-[11.5rem] top-[12rem] rounded-t-full"></div>
            </div>
